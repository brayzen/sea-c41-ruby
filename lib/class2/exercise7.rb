...
puts 'Chapter 1:  Getting Started'.ljust(40) + 'page  1'.rjust(10)
puts 'Chapter 2:  Numbers'.ljust(40) + 'page  9'.rjust(10)
puts 'Chapter 3:  Letters'.ljust(40) + 'page 13'.rjust(10)
